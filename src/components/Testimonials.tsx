...
const testimonials = [
  {
    ...
    content:
      "Vijay transformed our vision into reality. His attention to detail and technical expertise are unmatched. The final product exceeded all our expectations.",
    rating: 5,
  },
  {
    id: 2,
    ...
    content:
      "Working with Vijay was an absolute pleasure. He brought creative solutions to complex problems and delivered on time. Highly recommended!",
    rating: 5,
  },
  {
    id: 3,
    ...
    content:
      "The level of craftsmanship in Vijay's work is exceptional. He doesn't just build websites—he creates experiences that users love.",
    rating: 5,
  },
];

// Animation variants for the container and cards (no changes)
...
export default function Testimonials() {
  ...
  // GSAP title animation (no changes, it's great)
  useEffect(() => {
  ...
  return (
    ...
    >
      ...
      <div className="container relative z-10">
        ...
        {/* --- ✨ UPDATED TESTIMONIAL CARDS GRID --- */}
        <motion.div
        ...
        >
          {testimonials.map((testimonial) => (
            <motion.div
              ...
              // NEW: Enhanced hover animation for the subtle lift and shadow effect
              whileHover={{
                y: -8, // Lifts the card up
                boxShadow: "0 10px 30px rgba(0, 0, 0, 0.2)", // Deeper shadow
              }}
              // NEW: Smooth transition for hover-on and hover-off
              transition={{ duration: 0.3, ease: "easeInOut" }}
              // Modified class for a subtle border on hover
        ...
        <div className="relative max-w-5xl mx-auto">
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <h4 className="font-display text-2xl md:text-3xl mb-2">
                {testimonials[current].name}
              </h4>

              <p className="text-muted text-sm md:text-base uppercase tracking-widest">
